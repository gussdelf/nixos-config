...
setw -g window-status-activity-style "none,fg=#3e8fb0,bg=#374247"
setw -g window-status-separator ""
setw -g window-status-style "none,fg=#999f93,bg=#374247"
set -g status-left "#[fg=#2f383e,bg=#3e8fb0] #S #[fg=#3e8fb0,bg=#4a555b,nobold,nounderscore,noitalics]#[fg=#999f93,bg=#4a555b] %R #[fg=#4a555b,bg=#374247,nobold,nounderscore,noitalics]"
set -g status-right "#[fg=#4a555b,bg=#374247,nobold,nounderscore,noitalics]#[fg=#999f93,bg=#4a555b] %a #[fg=#3e8fb0,bg=#4a555b,nobold,nounderscore,noitalics]#[fg=#2f383e,bg=#3e8fb0] #H #{prefix_highlight} "
