...
_G.packer_plugins = {
  ...
  ["go.nvim"] = {
    config = { "\27LJ\2\nD\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\ago\30plugins.configs.lspconfig\frequire\0" },
    load_after = {
      ["nvim-lspconfig"] = true
    },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/home/gengar/.local/share/nvim/site/pack/packer/opt/go.nvim",
  ...
  ["nvim-lspconfig"] = {
    after = { "rust-tools.nvim", "go.nvim", "lsp_signature.nvim", "navigator.lua", "trouble.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-rainbow", "tabout.nvim", "nvim-treesitter-textobjects", "nvim-ts-autotag", "hlargs.nvim" },
...
vim.cmd [[au FileType sh ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "sh" }, _G.packer_plugins)]]
vim.cmd [[au FileType vue ++once lua require("packer.load")({'nvim-ts-autotag', 'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "vue" }, _G.packer_plugins)]]
vim.cmd [[au FileType java ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "java" }, _G.packer_plugins)]]
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "ruby" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType julia ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "julia" }, _G.packer_plugins)]]
vim.cmd [[au FileType nix ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "nix" }, _G.packer_plugins)]]
vim.cmd [[au FileType yaml ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'hlargs.nvim'}, { ft = "yaml" }, _G.packer_plugins)]]
vim.cmd [[au FileType cmake ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'hlargs.nvim'}, { ft = "cmake" }, _G.packer_plugins)]]
vim.cmd [[au FileType toml ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'hlargs.nvim'}, { ft = "toml" }, _G.packer_plugins)]]
vim.cmd [[au FileType lisp ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "lisp" }, _G.packer_plugins)]]
vim.cmd [[au FileType c ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "c" }, _G.packer_plugins)]]
vim.cmd [[au FileType gomod ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'hlargs.nvim'}, { ft = "gomod" }, _G.packer_plugins)]]
vim.cmd [[au FileType fish ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'hlargs.nvim'}, { ft = "fish" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'vimtex', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nabla.nvim', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "tex" }, _G.packer_plugins)]]
vim.cmd [[au FileType fennel ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'hlargs.nvim'}, { ft = "fennel" }, _G.packer_plugins)]]
vim.cmd [[au FileType json ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'hlargs.nvim'}, { ft = "json" }, _G.packer_plugins)]]
vim.cmd [[au FileType vim ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "vim" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascriptreact ++once lua require("packer.load")({'nvim-ts-autotag', 'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "javascriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'nvim-ts-autotag', 'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'nvim-ts-autotag', 'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType make ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'hlargs.nvim'}, { ft = "make" }, _G.packer_plugins)]]
vim.cmd [[au FileType cpp ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "cpp" }, _G.packer_plugins)]]
vim.cmd [[au FileType rust ++once lua require("packer.load")({'rust-tools.nvim', 'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType bash ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "bash" }, _G.packer_plugins)]]
vim.cmd [[au FileType zsh ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "zsh" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-ts-autotag', 'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType php ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "php" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { ft = "qf" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'markdown-preview.nvim', 'nvim-dap', 'nabla.nvim', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'go.nvim', 'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescriptcommon ++once lua require("packer.load")({'nvim-ts-autotag', 'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "typescriptcommon" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'nvim-ts-autotag', 'LuaSnip', 'cmp-nvim-lua', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'cmp-buffer', 'nvim-lspconfig', 'lsp_signature.nvim', 'nvim-dap', 'nvim-treesitter', 'navigator.lua', 'cmp-tmux', 'cmp-path', 'friendly-snippets', 'cmp-tabnine', 'cmp_luasnip', 'nvim-autopairs', 'hlargs.nvim', 'nvim-cmp', 'nvim-dap-ui'}, { ft = "javascript" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'venn.nvim', 'hop.nvim', 'indent-blankline.nvim', 'marks.nvim', 'nvim-treesitter', 'null-ls.nvim', 'numb.nvim', 'harpoon', 'gitsigns.nvim', 'trouble.nvim', 'todo-comments.nvim', 'undotree'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWritePre * ++once lua require("packer.load")({'mkdir.nvim'}, { event = "BufWritePre *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-repeat', 'vim-surround', 'gruvbox-material', 'telescope.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
time([[Sourcing ftdetect script at: /home/gengar/.local/share/nvim/site/pack/packer/opt/go.nvim/ftdetect/go.vim]], true)
vim.cmd [[source /home/gengar/.local/share/nvim/site/pack/packer/opt/go.nvim/ftdetect/go.vim]]
time([[Sourcing ftdetect script at: /home/gengar/.local/share/nvim/site/pack/packer/opt/go.nvim/ftdetect/go.vim]], false)
